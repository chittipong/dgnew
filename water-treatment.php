...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','water_treatment',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','water_treatment',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','water_treatment',$lang);
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Water Treatment</li>
				</ul>
			</div>
		</div>
	</div>
        ...
        <div class="container">
        	<div class="row">
              <div class="col-lg-12">
                ...
                <?php echo $p1_detail ?>
				<div class="col-lg-12"><img src="images/water-treatment/main.jpg"> </div>
                </div>
            </div>

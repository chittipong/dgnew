...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','swimming_pool',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','swimming_pool',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','swimming_pool',$lang);
        ...
        <div class="container">
        	<div class="row">
              <div class="col-lg-12">
				...
				<div class="col-lg-12 margintop40"><img src="images/swimming-pool/main.JPG"> </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
           	    	 <img src="images/swimming-pool/001.JPG"> 
                </div>
                <div class="col-lg-6"> 
            ...
            <div class="row">
                <div class="col-lg-6">
                	<img src="images/swimming-pool/002.JPG">
                </div>
              <div class="col-lg-6">

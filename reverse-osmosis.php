...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','reverse_osmosis',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','reverse_osmosis',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','reverse_osmosis',$lang);
...
if($lang=='TH'){
	...
	$p8_title=$myFn->getData($conn,'title_th','content',"WHERE page='$page' AND specific_name='p8'");
	$p8_detail=$myFn->getData($conn,'desc_th','content',"WHERE page='$page' AND specific_name='p8'");
	...
	$p5_title=$myFn->getData($conn,'title_en','content',"WHERE page='$page' AND specific_name='p5'");
	$p5_detail=$myFn->getData($conn,'desc_en','content',"WHERE page='$page' AND specific_name='p5'");
	
	$p6_title=$myFn->getData($conn,'title_en','content',"WHERE page='$page' AND specific_name='p6'");
	$p6_detail=$myFn->getData($conn,'desc_en','content',"WHERE page='$page' AND specific_name='p6'");
	
	$p7_title=$myFn->getData($conn,'title_en','content',"WHERE page='$page' AND specific_name='p7'");
	$p7_detail=$myFn->getData($conn,'desc_en','content',"WHERE page='$page' AND specific_name='p7'");
	
	$p8_title=$myFn->getData($conn,'title_en','content',"WHERE page='$page' AND specific_name='p8'");
	$p8_detail=$myFn->getData($conn,'desc_en','content',"WHERE page='$page' AND specific_name='p8'");
}
?>
        ...
        <div class="container">
        	<div class="row">
              <div class="col-lg-12">
				...
				<div class="col-lg-12 marginTop40"><img src="images/reverse-osmosis/main.jpg"> </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
           	    	<img src="images/reverse-osmosis/001.jpg"> 
                </div>
                <div class="col-lg-6"> 
            ...
            <div class="row">
                <div class="col-lg-6">
           	    	<img src="images/reverse-osmosis/002.jpg"> 
                </div>
              <div class="col-lg-6">
                ...
                <p><?php echo $p5_detail ?></p>

                 
                <h4><?php echo $p6_title ?></h4>
                <p><?php echo $p6_detail ?></p>
                </div>
            </div>
